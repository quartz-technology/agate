...
func TestNewDefaultHeadListener(t *testing.T) {
	t.Parallel()

	listener := NewDefaultHeadListener()

	require.NotNil(t, listener)
	require.Nil(t, listener.beaconAPIClient)
}

func TestDefaultHeadListener_Init(t *testing.T) {
	t.Parallel()
...
func TestDefaultHeadListener_Listen(t *testing.T) {
	t.Parallel()
